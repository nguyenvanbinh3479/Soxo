...
function run() {   
    result = ""; 
    prefix_first = shuffle([0,1]);
    first_arr = prefix_first.concat(shuffle(createArr(2,9)));
    result += first_arr[0];
...
function updateResult(){
    jQuery("#level").append("<div class='two'>"
        + "<div class='ot'>"
        + "<h1>" + level + "</h1>"
        + " <img src='"+ (level % 2) + "st.png'>"
        + "</div>"
        + "<div class='tt'>"
        + "  <h2>" + result + "</h2>"
        + "</div>"
